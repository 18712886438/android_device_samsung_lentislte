...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/jack_alsa_mixer.json:system/etc/jack_alsa_mixer.json
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/libnfc-sec.conf:system/etc/libnfc-nxp.conf \
...
# Ramdisk(add copy_package temporarily besause of I have no ideal how this does not work?)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/ramdisk/fstab.qcom:root/fstab.qcom \
    $(LOCAL_PATH)/ramdisk/init.qcom.post_boot.sh:root/init.qcom.post_boot.sh \
    $(LOCAL_PATH)/ramdisk/init.qcom.rc:root/init.qcom.rc \
    $(LOCAL_PATH)/ramdisk/init.qcom.usb.rc:root/init.qcom.usb.rc \
    $(LOCAL_PATH)/ramdisk/init.qcom.usb.sh:root/init.qcom.usb.sh \
    $(LOCAL_PATH)/ramdisk/init.sec.boot.sh:root/init.sec.boot.sh \
